module.exports = function(fragment, block, element, text, parse, modifiers) {
    return fragment([ element("div", {
        ...
        "class": [ "col-md-4" ]
    }, [ text(" "), element("h3", {}, [ text("Broad platform support, IE too!") ]), text(" "), element("p", {}, [ text(" Mojo.js was built to support all JavaScript platforms including IE 7+, and node.js. No need to modify your style to support a specific runtime. Write your application one way, and mojo will handle the rest. ") ]), text(" ") ]), text(" ") ]), text(" "), element("div", {
        "class": [ "row" ],
