...
var application = new ChatroomApplication();
app.eventBus.publish("/initializeRealtime");
app.eventBus.publish("/channel", "chatroom");

exports.run = function (element) {
  element.appendChild(app.views.create("chatroom", {
