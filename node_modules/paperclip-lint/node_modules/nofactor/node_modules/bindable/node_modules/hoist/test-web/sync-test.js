(function() {
    ...
    define("hoist/test-web/sync-test.js", function(require, module, exports, __dirname, __filename) {
        var hoist = require("hoist/lib/index.js"), expect = require("expect.js/expect.js"), structr = require("structr/lib/index.js");
        describe("sync", function() {
            var numberCaster, arrayCaster, numberTransformer;
            var Person = structr({
            ...
            it("can properly map a value", function() {
                var result = hoist.cast(Number).map(function(value) {
                    return {
                        value: value
                    };
                })("5");
            ...
            it("can cast a person", function() {
                var result = hoist.cast(Person)({
                    name: "craig"
                });
                expect(result).to.be.an(Person);
            });
            it("can pre-cast a person", function() {
                var result = hoist.postCast(Person).preMap(function(value) {
                    return {
                        name: value
                    };
                })("craig");
    ...
    var entries = [ "hoist/test-web/sync-test.js" ];
