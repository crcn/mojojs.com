...
<html lang="en">
<head>
    <title>Code coverage report for lib/clip/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/clip/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.1% <small>(97 / 102)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">90% <small>(36 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.55% <small>(28 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.88% <small>(93 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/clip/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if(this._debounceTimeout) <span class="cstat-no" title="statement not covered" >clearTimeout(this._debounceTimeout);</span></span>
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
<span class="cstat-no" title="statement not covered" >    this._debounceTimeout = setTimeout(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      self.update();</span>
    }, 0);
  }
});
&nbsp;
...
&nbsp;
  reset: function (data, update) {
    this.data = data ? data : <span class="branch-1 cbranch-no" title="branch not covered" >new bindable.Object();</span>
    if (update !== false) {
      this.update();
    }
  },
