...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/bindings/block/value.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/bindings/block/value.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/paper/bindings/block/</a> &#187; value.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (this.nodeFactory.name === "dom") {
<span class="cstat-no" title="statement not covered" >      this.node.nodeValue = String(value);</span>
    } else <span class="missing-if-branch" title="else path not taken"" >E</span>if(this.node.replaceText) {
...
&nbsp;
module.exports = ValueDecor;</pre></td></tr>
</table></pre>
