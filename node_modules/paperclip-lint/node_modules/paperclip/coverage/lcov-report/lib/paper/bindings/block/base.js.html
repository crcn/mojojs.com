...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/bindings/block/base.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/bindings/block/base.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/paper/bindings/block/</a> &#187; base.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var BaseScriptBinding = require("../base/script");
&nbsp;
...
&nbsp;
   ...
   */
&nbsp;
  test: <span class="fstat-no" title="function not covered" >function (node) {</span>
