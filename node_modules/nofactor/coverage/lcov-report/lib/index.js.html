...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = {
  string : require("./string"),
  dom    : require("./dom")
};
&nbsp;
module.exports["default"] = typeof window !== "undefined" ? <span class="branch-0 cbranch-no" title="branch not covered" >module.exports.dom </span>: module.exports.string;</pre></td></tr>
</table></pre>
