...
<html lang="en">
<head>
    <title>Code coverage report for lib/parser/script/tokenizer.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/parser/script/tokenizer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.88% <small>(62 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">95.83% <small>(46 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/parser/script/</a> &#187; tokenizer.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var BaseTokenizer = require("../base/tokenizer"),
utils = require("../utils");
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (/^as$/.test(word)) <span class="cstat-no" title="statement not covered" >return this._t(codes.AS, word);</span>
&nbsp;
...
&nbsp;
    ...
    // !, !=, !==
      ...
      if (this._s.peek(2) === "!=") {
        this._s.skip(1);
&nbsp;
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (this._s.peek(2) === "==") {
          this._s.skip(1);
          return this._t(codes.ANEQ, "!==");
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this._t(codes.NEQ, "!=");</span>
      } else {
