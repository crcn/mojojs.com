...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/bindings/block/conditional.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/bindings/block/conditional.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/paper/bindings/block/</a> &#187; conditional.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (this._oldValue === value) {
...
&nbsp;
  ...
  unbind: function () {
    ...
    return this.child ? this.child.dispose() : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
  }
});
&nbsp;
