...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/bindings/node/factory.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/bindings/node/factory.js</span></h1>
    <h2>
        
        Statements: <span class="metric">86.21% <small>(50 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">85.96% <small>(49 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/paper/bindings/node/</a> &#187; factory.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        cn = cn.childNodes[p[i]];</span>
      }
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!/node|attr/.test(String(type))) {
<span class="cstat-no" title="statement not covered" >      throw new Error("node binding class '"+bindingClass.name+"' must have property type 'node', or 'attr'");</span>
    }
&nbsp;
