...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/bindings/node/attrs/text/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/bindings/node/attrs/text/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">lib/paper/bindings/node/attrs/text/</a> &#187; index.js</div>
</div>
<div class="body">
...
BaseBinding.extend(AttrTextBinding, {
  ...
  unbind: function () {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (this._binding) this._binding.dispose();
