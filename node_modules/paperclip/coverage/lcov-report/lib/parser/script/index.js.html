...
<html lang="en">
<head>
    <title>Code coverage report for lib/parser/script/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/parser/script/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">99.05% <small>(104 / 105)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/parser/script/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var BaseParser  = require("../base/parser"),
...
&nbsp;
  _parseExpression: function () {
    var ccode;
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!(ccode = this._t.currentCode)) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
