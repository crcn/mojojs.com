...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/bindings/node/attrs/dataBind/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/bindings/node/attrs/dataBind/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">lib/paper/bindings/node/attrs/dataBind/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Clip          = require("../../../../../clip"),
...
&nbsp;
  for (var i = 0, n = this.clip.scripts.names.length; i &lt; n; i++) {
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!(bc = dataBindingClasses[scriptName])) <span class="cstat-no" title="statement not covered" >continue;</span>
