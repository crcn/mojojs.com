...
<html lang="en">
<head>
    <title>Code coverage report for lib/paper/template.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/paper/template.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/paper/</a> &#187; template.js</div>
</div>
<div class="body">
...
&nbsp;
    var node = this.useTemplateNode ? this._templateNode.cloneNode(true) : <span class="branch-1 cbranch-no" title="branch not covered" >this._templateNode;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!tpl.compiler) {
<span class="cstat-no" title="statement not covered" >      throw new Error("template must be a function");</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    isIE = ~navigator.userAgent.toLowerCase().indexOf("msie") || ~navigator.userAgent.toLowerCase().indexOf("trident")</span>
  }
&nbsp;
  var ops = {
