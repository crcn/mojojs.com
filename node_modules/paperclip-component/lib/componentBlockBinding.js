  ...
  module.exports = function(Component) {
    ...
    return ComponentBlockBinding = (function(_super) {
      ...
      function ComponentBlockBinding() {
        ...
        ComponentBlockBinding.__super__.constructor.apply(this, arguments);
      ...
      ComponentBlockBinding.prototype._createComponent = function(viewName) {
        ...
        this._component.set("parent", this.context);
        this.section.append(this._component.render());
      ...
      ComponentBlockBinding.prototype._changeViewOptions = function(componentOptions) {
        ...
        for (key in componentOptions) {
          ...
          if (v && v.__isBindableReference) {
            this._janitor.add(this._bindTo(key, v));
            v = v.value();
          }
          _results.push(this._component.set(key, v));
        }
        return _results;
      };
      ...
      ComponentBlockBinding.prototype._bindTo = function(key, bindableReference) {
        return this._component.bind(key, function(value) {
          return bindableReference.value(value);
        });
      };
